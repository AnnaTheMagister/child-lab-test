...
function boilerplate_load_assets()
{
  ...
  wp_enqueue_style('coursesinglecss', get_theme_file_uri('/assets/styles/course-single.css'), array(), filemtime(get_template_directory() . ('/assets/styles/course-single.css')));
}
