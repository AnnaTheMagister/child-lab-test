...
$tags = get_terms([
    ...
    'hide_empty' => false,
    'meta_key' => 'order',          // Указываем meta_key
...
if ($tags && !is_wp_error($tags)):
    ...
    <div class="container">
        <div class="methodology-tags-menu">
            <a href="<?php echo get_site_url() ?>/?methodology=-1&articles_count=<?php echo $articles_count = '5' ?>"
            ...
            <?php foreach ($tags as $index => $tag): ?>
                ...
                <a href="?methodology=<?php echo $tag->term_id; ?>&articles_count=<?php echo $articles_count = '5' ?>"
